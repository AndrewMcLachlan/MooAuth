...
export const getAllConnectors = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetAllConnectorsResponse, GetAllConnectorsError, ThrowOnError>({
    ...options,
    url: '/api/connectors'
}); };

export const getAvailableConnectorTypes = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetAvailableConnectorTypesResponse, GetAvailableConnectorTypesError, ThrowOnError>({
    ...options,
...
export const getEntraConnector = <ThrowOnError extends boolean = false>(options: Options<GetEntraConnectorData, ThrowOnError>) => { return (options?.client ?? client).get<GetEntraConnectorResponse, GetEntraConnectorError, ThrowOnError>({
    ...options,
    url: '/api/connectors/entra/{id}'
}); };

export const updateEntraConnector = <ThrowOnError extends boolean = false>(options: Options<UpdateEntraConnectorData, ThrowOnError>) => { return (options?.client ?? client).patch<UpdateEntraConnectorResponse, UpdateEntraConnectorError, ThrowOnError>({
    ...options,
    url: '/api/connectors/entra/{id}'
}); };

export const createEntraConnector = <ThrowOnError extends boolean = false>(options: Options<CreateEntraConnectorData, ThrowOnError>) => { return (options?.client ?? client).post<CreateEntraConnectorResponse, CreateEntraConnectorError, ThrowOnError>({
    ...options,
