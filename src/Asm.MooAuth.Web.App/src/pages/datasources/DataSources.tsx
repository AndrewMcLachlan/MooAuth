...
export const DataSources = () => {
    ...
    return (
        <Page title="Data Sources" breadcrumbs={[{ text: "Data Sources", route: "/datasources" }]} actions={[<IconButton key="add" onClick={() => navigate("/datasources/create")} icon="plus">Create Data Source</IconButton>]}>
