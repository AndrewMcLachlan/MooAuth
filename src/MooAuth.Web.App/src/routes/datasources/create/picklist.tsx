...
export const Route = createFileRoute("/datasources/create/picklist")({
    ...
    const handleSubmit = async (data: CreatePickListForm) => {
        if (data.valueSource === "manual") {
            createManualPickList.mutate({
                ...
                onSuccess: (response) => navigate({ to: "/datasources/picklist/$id", params: { id: String(response.id) } }),
            });
        } else {
            createApiPickList.mutate({
                ...
                onSuccess: (response) => navigate({ to: "/datasources/apipicklist/$id", params: { id: String(response.id) } }),
            });
        }
    };
